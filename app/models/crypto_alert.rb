  ...
  def send_notification
    ...
    if (self.should_send_email)
      begin
        ...
        CryptoAlertMailer.send_email(email: self.user.email, subject: "CryptoCurrently - " + self.cryptocurrency.label + ": $" + self.cryptocurrency.price.to_s, message: "Sent with CryptoCurrently.app").deliver
      rescue => e
